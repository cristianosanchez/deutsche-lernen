...
to make; to submit (sth)

abhalten
hält ab · hielt ab · hat abgehalten
to hold (sth); to prevent (sth)

abholen
holt ab · holte ab · hat abgeholt
to collect (sb/sth); to pick (sb/sth) up
...
to cancel (sth); to call (sth) off

abschalten
schaltet ab · schaltete ab · hat abgeschaltet
to switch (sth) off; to shut (sth) down
...
absteigen
steigt ab · steigt ab · ist abgestiegen
to get off; to dismount

aussteigen
steigt aus · steigt aus · ist ausgestiegen
...
to respect; to esteem (sb)
@Der Junge achtet seinen Großvater mehr als alle anderen Menschen.
...
anziehen
zieht an · zog an · ist angezogen
to attract (sb/sth); to put on (dress); to tighten; to pull
...
to give up; to place/order (sth)

aufhalten
hält auf · hielt auf/hat aufehalten
to stop (sth); to delay
...
to take (sth); to record; to include (sth); to pick (sth) up; to receive (sth)
...
to tidy (sth); to clean (sth) up

aufschieben
schiebt auf · schob auf · hat aufgeschoben
to postpone; to defer (sth) 
@Unser Chef hat die Besprechung aufgeschoben, weil er sich unwohl fühlte. 
...
aufteilen
teilt auf · teilte auf · ist aufgeteilt
separar; dividir; dividir em grupos
...
ausflippen
ficar maluca (gostar de algo); freaky out

auslöschen
löschst aus · löschte aus · hat ausgelöscht
extinguir; extinguir o fogo

ausschalten
schaltet aus · schaltete aus · hat ausgeschaltet
desligar; desligar a TV

aussteigen
steigt aus · stieg aus · hat ausgestiegen
sair; desembarcar; sair do carro

austauschen
tauscht aus · tauschte aus · hat ausgetauscht
trocar; trocar entre pessoas

auswechseln
wechselt aus · wechselte aus · hat ausgewechselt
substituir; substituir um objeto
...
beauftragen
beaufträgt · beauftrug · hat beauftragen
comprometer; se comprometeu a fazer
...
operar; operar o computador; servir; todos serão servidos
...
begrüßen
begrüsst · begrüsste · hat begrüsst
saudar; saudar alguém

behalten
behält · behielt · hat behalten
reter; manter; manter a funcionalidade
...
corrigir; remediar o problema

bekommen
bekommt · bekam · hat bekommen
receber; obter; receber as flores

belegen
belegt · belegte · hat belegt
demonstrar; provar; comprovar o pagamento

benutzen
benutzt · benutzte/ · hat benutzt
usar; usar o telefone

benötigen
benötigt · benötigte · hat benötigt
precisar; precisar de ajuda
...
decidir; resolver cortar o cabelo

beschreiben
beschreibt · beschreib · hat beschreiben
descrever; descrever uma pessoa

besitzen
besitzt · besaß · hat besessen
possuir; possuir features de segurança
...
ordenar; apontar ou nomear alguém
...
visitar; atender uma reunião

betrachten
betrachtet · betrachtete · hat betrachtet
considerar; olhar de diferentes ângulos

betreffen
betrifft · betraf · hat betroffen
relacionar; afetar alguém

betreten
betritt · betrat · ist betreten
entrar; acessar

betrieben
betriebt · betrieben · hat betrieben
executar; rodar um programa de computador
...
cobrir; cobrir pelo seguro; encontrar; difícil de encontrar; satisfazer; satisfazer a demanda
...
tomar; tomar o medicamento; ocupar; ocupar o tempo

einrichten
richtet ein · richtete ein · hat eingerichtet
estabelecer; construir; set something up
...
embarcar; entrar no trem

einstellen
configurar; configurar; set; set as default; contratar; contratar funcionários
...
descobrir (algo novo); achar (um novo restaurante)
...
entgegennehmen
nimmst entgegen · nahm entgegen · hat entgegengenommen
receber; receber um presente

entkommen
entkommt · entkam · bin entkommen
escapar; fugir
...
erkennen
erkennt · erkannte · hat ekannt
reconhecer

erleben
experienciar (uma situação); testemunhar;
...
cair; derrubar; Meine Schlüssel ~ aus mainer Tasche
...
festlegen
marcar; estabelecer; especificar
...
to research (als (der) Wissenschaftler)
...
hinterlassen
deixar (uma mensagem telefonica, um recado)
...
legen
colocar algo na horizontal/deitado
...
querer dizer; significa; achar; pensar
...
schmerzen
schmerzt · schmerzten · hat geschmerzt
doer; machucar
...
schnupfen
schnupft · schnupfte · hat geschnupft
aspirar; cheirar

schreien
gritar; gritar com alguém
...
extender-se; esticar-se

sich kümmern
se preocupar com alguém

sich mokieren
mokiert sich · mokierte sich · hat sich mokiert
imitar; zombar
...
sich umziehen
 trocar-se; trocar de roupa

sich wandeln
hat gewandelt
mudar;@So scnell hat sich das Wetter noch nie gewandelt.
...
stampfen
carimbar;bater os pés;pisar forte
...
steigen
subir (num carro, num animal, o nascer-do-sol, a fumaça)

stellen
colocar algo na vertical
...
espalhar (vírus, notícia, etc)

verbringen
passar (o tempo, as férias, o ano)

vereinbaren
vereinbart · vereinbarte · hat vereinbart
acordar (um compromisso); arranjar (um compromisso)

vergeben
atribuir; conceder; perdoar
...
sair; deixar; abandonar

verleihen
dar; premiar; alugar;

verletzen
violar; ferir; infringir; ofender

verlieren
perder

vermeiden
evitar; previnir; impedir
...
verwenden
verwendet · verwandte · hat verwandt
utilizar; usar
...
acusar; culpar; censurar

wahrnehmen
exercer; desempenhar; assumir
...
zustimmen
concordar; aceitar; aprovar

zählen
contar; incluir; confiar

öffnen
abrir; destrancar

übergeben
entregar; transferir; vomitar

übermitteln
transmitir; enviar; fornecer

übernehmen
assumir; aceitar; desempenhar
